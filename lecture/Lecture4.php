...
<div class="navbar">
  ...
  <a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
	<a href ="Lecture3.php" class="dropbtn">Go back to lecture 3</a>
	<a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
	<a href ="Lecture5.php" class="dropbtn">Go next to Lecture 5</a>
</div>
<br>

<h1 class="head">Lecture 4</h1>
<div class="container">
	<div class="content">
<h2>Topic: Handling User Input</h2>
		<p>
		<ul>
